      ...
      public class VesselObserver
      {
         ...
         public static VesselObserver Instance()
         {
            if (instance == null)
            {
               ...
               Log.Info("newvessel observer instance created");
            }
            return instance;
         }
         ...
         {
            public double KerbinLaunchTime = NO_TIME;
         ...
         public void SetKerbinLaunchTime(Vessel vessel, double time)
         {
            ...
            data.KerbinLaunchTime = time;
         }

         public double GetKerbinLaunchTime(Vessel vessel)
         {
            Guid id = vessel.id;
            if (vesselData.ContainsKey(id))
            {
               return vesselData[id].KerbinLaunchTime;
            }
            return NO_TIME;
         }
         ...
         public void Revert(double time)
         {
            ...
            foreach (Guid id in vesselData.Keys)
            {
               ...
               if (data.KerbinLaunchTime > time) data.KerbinLaunchTime = NO_TIME;
            }
         }
         ...
         public override string ToString()
         {
            ...
            foreach (Guid id in vesselData.Keys)
            {
               result = result + id + "=" + vesselData[id].KerbinLaunchTime + "/";
            }
            result = result + "]";
            return result;
         }
