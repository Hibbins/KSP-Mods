   ...
   namespace FinalFrontier
   {
      ...
      class FastOrbitAchievement : NumericAchievement
      {
         ...
         public override bool Check(VesselState previous, VesselState current)
         {
            ...
            double launchTime = VesselObserver.Instance().GetKerbinLaunchTime(current.Origin);
      ...
      class HighGeeForceAchievement : NumericAchievement
      {
         ...
         public override String GetText()
         {
            return "Awarded for withstanding an acceleration of at least " + value + "g for at least " + GeeForceInspector.DURATION.ToString("0.0")+" seconds";
         }
      }
